...
await assert.rejects(()=>change('inactive'),e=>e.code==='42883');checks++;
const repair=readFileSync(new URL('../../src/database/migrations/20260924_f1_23b_membership_identity_types.sql',import.meta.url),'utf8');await db.exec(repair);await db.exec(repair);
