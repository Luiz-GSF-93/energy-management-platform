...
export class CalculationPreparationService {
 ...
 return {...prepareMonth(u,d.month,parameters,contracts,prices,management,services,monthly,monthlyCosts),costLedger:monthlyCostLedger(u,d.month,monthlyCosts),tariffPreview:previewTariffs(u,d.month,period,parameters,monthly),checkedAt:new Date().toISOString()};
 }
}
