...
export class CalculationPreparationService {
 ...
 const [parameters,contracts,management,services]=await Promise.all([
 ...
 return {...prepareMonth(u,d.month,parameters,contracts,prices,management,services),checkedAt:new Date().toISOString()};
 }
}
