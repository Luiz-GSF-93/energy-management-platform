...
export class CalculationPreparationService {
 ...
 const [parameters,contracts,management,services,monthly]=await Promise.all([
 ...
 return {...prepareMonth(u,d.month,parameters,contracts,prices,management,services,monthly),checkedAt:new Date().toISOString()};
 }
}
