...
export default function AnalysisPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Análise de Consumo</h1>
        <p className="text-gray-400">Tendências e insights sobre seu consumo de energia</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="relative group">
          ...
          <div className="relative p-6">
            <h3 className="text-lg font-semibold text-white mb-6">Consumo por Mês</h3>
            {loading ? (
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-white/5 rounded-xl backdrop-blur-md border border-white/10"></div>
          <div className="relative p-6">
            <h3 className="text-lg font-semibold text-white mb-6">Custo por Mês</h3>
            {loading ? (
              <div className="flex justify-center h-80">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-orange-500"></div>
              </div>
      ...
      <div className="relative group mt-8">
        ...
        <div className="relative p-6">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
              <span className="text-blue-400 font-bold">💡</span>
              <p className="text-gray-300">Seu consumo pico é às <strong>18h</strong>. Tente usar aparelhos de alto consumo fora deste horário.</p>
            </li>
            <li className="flex items-start gap-3 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
              <span className="text-green-400 font-bold">✓</span>
              <p className="text-gray-300">Seu consumo <strong>diminuiu 3.2%</strong> em relação ao mês anterior.</p>
            </li>
            <li className="flex items-start gap-3 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <span className="text-yellow-400 font-bold">⚠️</span>
              <p className="text-gray-300">Setembro teve um consumo <strong>9% acima da média</strong> de seus últimos 6 meses.</p>
            </li>
          </ul>
        </div>
      </div>
