...
const tabs=[['distributor','Distribuidora e unidades'],['supply','Fornecedor Mercado Livre'],['management','Honorários da gestão'],['services','Intermediação e outros'],['parameters','Parâmetros de cálculo'],['preparation','Preparar apuração']] as const;
